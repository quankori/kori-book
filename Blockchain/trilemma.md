...
- Là một thuật ngữ dùng để chỉ có thể thực hiện hai trong ba yếu tố và sẽ dễ đổ vỡ nếu cố tình thi hành cả ba yếu tố cùng một lúc.

- Bộ ba bất khả thi trong blockchain gồm: khả năng mở rộng (Scalability), vấn đề an ninh (Security) và tính phi tập trung hay phân cấp (Decentralization).
